...
## Requirement
This tutorial assume you have an account with [openai.com](https://openai.com). You will need to get an api token from it.
...
=== ":octicons-image-16: Setup"
    ...
    1.  Go to [openai.com](https://openai.com) and log in.
