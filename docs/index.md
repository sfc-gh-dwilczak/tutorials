...
## Starting:
The best place to start would be to go over my [basic](https://sfc-gh-dwilczak.github.io/tutorials/snowflake/setup/basic/) setup for users or an integration(aws,azure,gcp, etc) your intrested in using.