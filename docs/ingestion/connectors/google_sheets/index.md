...
## Openflow
In this tutorial we assume you already have a deployment. If you have not it only takes a few minutes. Please follow one of the two options [Snowflake](https://sfc-gh-dwilczak.github.io/tutorials/ingestion/deployments/snowflake/) or [AWS](https://sfc-gh-dwilczak.github.io/tutorials/ingestion/deployments/aws).

### Runtime
Inside openflow click runtimes. Click "+ Create runtime".
