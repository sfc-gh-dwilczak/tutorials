...
- Connector ([Link](https://sfc-gh-dwilczak.github.io/tutorials/ingestion/connectors/api/files/files.zip))
...
We'll click "Browse" button and upload our [connector](https://sfc-gh-dwilczak.github.io/tutorials/ingestion/connectors/api/files/files.zip) we downloaded at the start of the tutorial.
